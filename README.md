...
🔧 Update the connection string in ZenOS.API/appsettings.json:
...
* **Key** → Can be your name, company, or system name.
...
## 🌐 API Configuration
Ensure your API runs correctly by checking: ZenOS.API/Properties/launchSettings.json
...
Open ZenOSBE.sln in Visual Studio 2026.

Set ZenOS.API as the Startup Project.
